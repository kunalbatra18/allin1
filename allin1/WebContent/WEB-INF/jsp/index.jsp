		...
		<section class="idea-port" style="background-color: #333;">
			<section class="header-idea">
				<section class="row">
					...
					<section class="col-md-6 col-xs-6"></section>
					<%-- <section class="col-md-3 col-xs-3">
				...
				<section class="row">
								...
								<ul class="ca-menu">
									<section class="row">
										...
										<section class="col-md-6 col-xs-6">
											<li><a href="Wallpaper?cli=img"> <span
													class="ca-icon"> <img
										...
										<section class="col-md-6 col-xs-6">
											<li><a href="Video?cli=vid"> <span class="ca-icon">
										...
										<section class="col-md-6 col-xs-6">
											<li><a href="Animation?cli=anim"> <span
													class="ca-icon"> <img
														src="<c:url value="/resources/img_idea/animation.png" />" /></span>
													<div class="ca-content">
										...
										<section class="col-md-6 col-xs-6">
											<li><a href="Game?cli=game"> <span class="ca-icon">
														<img src="<c:url value="/resources/img_idea/games.png" />" />
												</span>
													<div class="ca-content">
					...
					<section class="banner">
						...
						<section class="bann-img">
							<a href="<c:url value= "/BuyOneGetOne" />"> <img
					...
					<section class="banner">
						...
						<section class="bann-img">
							<a href="<c:url value= "/FreeZone" />"> <img
								src="<c:url value="/resources/img_idea/free zone.png"/>" />
							</a>
						</section>
